...
from agent_project.agentcore.smart_home_agent.fake_request.fake_get_entity import entities, fake_get_states_by_entity_id, \
    test_

# todo 添加装饰器，执行服务后更新entity的时间信息
"""
饰器的执行顺序遵循 “就近原则”：
...
if __name__ == "__main__":
    print(fake_get_states_by_entity_id("media_player.xiaomi_cn_701074704_l15a"))
    print(fake_execute_domain_service_by_entity_id("media_player", "turn_off",
                                              '{"entity_id":"media_player.xiaomi_cn_701074704_l15a"}')==bad_request)
    print(fake_get_states_by_entity_id("media_player.xiaomi_cn_701074704_l15a"))