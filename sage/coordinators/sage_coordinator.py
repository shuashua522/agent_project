...
from sage.smartthings.persistent_command_tools import ConditionCheckerToolConfig, NotifyOnConditionToolConfig
...
if __name__ == "__main__":
    # SAGECoordinatorConfig().instantiate().execute("所有设备的状态")
    SAGECoordinatorConfig().instantiate().execute("打开台灯")
