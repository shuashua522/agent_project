...
累计输入 token 消耗列表（按文件序号）: [96267, 23306, 41117, 11952, 22632, 22774, 294, 301, 22682, 6650, 180447]
累计输出 token 消耗列表（按文件序号）: [4784, 1451, 988, 1611, 984, 1716, 635, 791, 1406, 2004, 20749]
累计总 token 消耗列表（按文件序号）: [101051, 24757, 42105, 13563, 23616, 24490, 929, 1092, 24088, 8654, 201196]

sasha：

累计输入 token 消耗列表（按文件序号）: [31008, 24337, 26963, 24227, 23926, 24237, 29606, 23354, 38855, 33707, 23259]
累计输出 token 消耗列表（按文件序号）: [3465, 2992, 2852, 2152, 1672, 1744, 5314, 3177, 2684, 3167, 3954]
累计总 token 消耗列表（按文件序号）: [34473, 27329, 29815, 26379, 25598, 25981, 34920, 26531, 41539, 36874, 27213]

onePrompt：

累计输入 token 消耗列表（按文件序号）: [33733, 21940, 11070, 11064, 21894, 22320, 434, 41601, 22023, 70432, 35838]
累计输出 token 消耗列表（按文件序号）: [1844, 1275, 567, 590, 490, 925, 541, 1751, 1106, 2442, 1893]
累计总 token 消耗列表（按文件序号）: [35577, 23215, 11637, 11654, 22384, 23245, 975, 43352, 23129, 72874, 37731]
