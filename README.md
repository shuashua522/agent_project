...
- 在哪个房间（修改实体的friendly_name)，✔【可以修改，没问题】

- 在处理请求体的中的计算问题时，gemma3:270m处理效果不行（有时候处理不了计算；返回格式不是json，而是代码）。目前使用的是qwen2.5:0.5b
- 之前就隐约存在的问题：在调用设备交互工具时，llm会做多余操作，https://smith.langchain.com/public/d8916e7e-cd75-4870-89b9-3ff5b8b499f5/r  ；在处理问题时，有时会反问
