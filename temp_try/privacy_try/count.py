...
def count_target_fields(log_file_path):
    ...
    field_patterns = {
        ...
        # 字符串型字段：排除被@包裹的情况（新增否定前瞻过滤）
        'entity_id': r'"entity_id":\s*"((?!@).)*[a-zA-Z0-9_.]+((?!@).)*"',
        'state': r'"state":\s*"((?!@).)*[a-zA-Z0-9_.]+((?!@).)*"',
...
if __name__ == "__main__":
    print(count_target_fields("12_Setthebrightnessofthelivingroomlightto50.log"))